...
return [
    ...
    'Incorrect token or token already used.' => 'Incorrect voting code or voting code already used.',
    'Invalid option' => '',
    'Invalid voting code' => '',
    'Is Admin' => '',
    'Is Valid' => '',
    ...
    'Participation' => '',
    'Password Hash' => '',
    'Please enter your token' => 'Please enter your Voting Code',
    'Please fill in your token in the form below to start voting!' => 'Please fill in your Voting Code in the form below to start voting!',
    ...
    'Select Max' => '',
    'Select Min' => '',
    'Select maximum {maximum, plural, =0{# Option} =1{# Option} other{# Options}}. Options selected: {count}.' => '',
    'Select maximum {maximum} of options. Options selected: {count}.' => '@@@@',
    'Select minimum {minimum, plural, =0{# Option} =1{# Option} other{# Options}}. Options selected: {count}.' => '',
    'Select minimum {minimum} of options. Options selected: {count}.' => '@@@@',
    'Select minimum {minimum}, maximum {maximum} Options. Options selected: {count}.' => '',
    ...
    'Title' => '',
    'Token' => 'Voting Code',
    'Token Input' => 'Voting Code Input',
    'Token was already used to vote.' => 'Voting code was already used to vote.',
